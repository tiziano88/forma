...
proto.forma.config.Config = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.forma.config.Config.repeatedFields_, null);
};
 ...
 * @return {!Object}
 */
proto.forma.config.FileMapping.prototype.toObject = function(opt_includeInstance) {
...
proto.forma.config.FileMapping.deserializeBinary = function(bytes) {
  ...
  return proto.forma.config.FileMapping.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.forma.config.FileMapping}
 */
proto.forma.config.FileMapping.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.forma.config.FileMapping.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getData();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {!proto.forma.config.FileMapping} returns this
 */
proto.forma.config.FileMapping.prototype.setSchemaDescriptor = function(value) {
 ...
 * @return {!Object}
 */
proto.forma.config.Config.prototype.toObject = function(opt_includeInstance) {
...
filesList: jspb.Message.toObjectList(msg.getFilesList(),
    proto.forma.config.FileMapping.toObject, includeInstance)
  };
...
proto.forma.config.Config.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      reader.readMessage(value,proto.forma.config.FileMapping.deserializeBinaryFromReader);
      msg.addFiles(value);
      break;
    default:
      reader.skipField();
...
proto.forma.config.Config.prototype.getFilesList = function() {
  return /** @type{!Array<!proto.forma.config.FileMapping>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.forma.config.FileMapping, 1));
};
...
proto.forma.config.Config.prototype.addFiles = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.forma.config.FileMapping, opt_index);
};
