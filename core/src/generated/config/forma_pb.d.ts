...
export class FileMapping extends jspb.Message {
  ...
  static toObject(includeInstance: boolean, msg: FileMapping): FileMapping.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: FileMapping, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): FileMapping;
  static deserializeBinaryFromReader(message: FileMapping, reader: jspb.BinaryReader): FileMapping;
}
