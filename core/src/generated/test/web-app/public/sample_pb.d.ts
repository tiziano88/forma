...
export class CatDetails extends jspb.Message {
  ...
  static toObject(includeInstance: boolean, msg: CatDetails): CatDetails.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: CatDetails, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): CatDetails;
  static deserializeBinaryFromReader(message: CatDetails, reader: jspb.BinaryReader): CatDetails;
}
