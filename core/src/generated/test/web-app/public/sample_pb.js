...
proto.example.Article = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.example.Article.repeatedFields_, null);
};
...
proto.example.Person = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.example.Person.repeatedFields_, null);
};
 ...
 * @return {!Object}
 */
proto.example.PhoneNumber.prototype.toObject = function(opt_includeInstance) {
...
proto.example.PhoneNumber.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = /** @type {!proto.example.PhoneNumber.PhoneType} */ (reader.readEnum());
      msg.setType(value);
      break;
    default:
      reader.skipField();
...
proto.example.PhoneNumber.prototype.getType = function() {
  return /** @type {!proto.example.PhoneNumber.PhoneType} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
...
phonesList: jspb.Message.toObjectList(msg.getPhonesList(),
    proto.example.PhoneNumber.toObject, includeInstance),
articlesList: jspb.Message.toObjectList(msg.getArticlesList(),
    proto.example.Article.toObject, includeInstance),
catsMap: (f = msg.getCatsMap()) ? f.toObject(includeInstance, proto.example.CatDetails.toObject) : []
  };
...
proto.example.Person.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      ...
      reader.readMessage(value,proto.example.PhoneNumber.deserializeBinaryFromReader);
      msg.addPhones(value);
      break;
    case 7:
      var value = new proto.example.Article;
      reader.readMessage(value,proto.example.Article.deserializeBinaryFromReader);
      msg.addArticles(value);
      break;
    case 8:
      var value = msg.getCatsMap();
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.example.CatDetails.deserializeBinaryFromReader, "", new proto.example.CatDetails());
         });
      break;
    default:
      reader.skipField();
...
proto.example.Person.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(8, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.example.CatDetails.serializeBinaryToWriter);
  }
};
...
proto.example.Person.prototype.getEyeColor = function() {
  return /** @type {!proto.example.EyeColor} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};
...
proto.example.Person.prototype.addPhones = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 6, opt_value, proto.example.PhoneNumber, opt_index);
};
...
proto.example.Person.prototype.addArticles = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 7, opt_value, proto.example.Article, opt_index);
};
